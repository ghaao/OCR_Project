...
from ocr_app.spoiler.imageProcessingFunction import imutils
from ocr_app.spoiler.imageProcessingFunction import polygon_interacter as poly_i
from ocr_app.spoiler.imageProcessingFunction import transform
...
class DocScanner(object):
    ...
    def scan(self, cv_img):

        # RESCALED_HEIGHT = 2000.0
